    ...
    return (
        <nav class="flex items-center justify-between flex-wrap bg-primary-2 rounded-t-md border-solid border-b border-lines">
            ...
            <div class="w-full  block flex-grow lg:flex lg:items-center lg:w-auto ">
                <div class="lg:flex-grow h-full w-auto">
                    <div class="inline-block  h-14 border-r  border-lines border-solid nav">
                ...
                <div class="h-14 border-l ml-6  border-lines border-solid nav">
